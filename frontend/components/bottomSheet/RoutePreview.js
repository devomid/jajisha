...
const RoutePreview = forwardRef(({ curentLocation, toiletInfoBottomSheetRef, onDismiss, onReopenToiletInfo }, ref) => {
            ...
            <View style={{ flex: 1, }}>
                <View style={{
                    ...
                    <Text
                        ...
                        {t("components.routePreview.routePreviewTitle")}
                    </Text>
                </View>
                ...
                >
                    ...
                    >
                        {t("components.routePreview.distanceTitle")}
                    </Text>
                    <Text
                        variant="bodyLarge"
                        style={{
                ...
                >
                    ...
                    >
                        {t("components.routePreview.etaTitle")}
                    </Text>
                    <Text
                        variant="bodyLarge"
                        style={{
